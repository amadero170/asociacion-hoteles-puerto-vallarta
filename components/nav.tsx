      ...
      <header className="fixed top-0 left-0 right-0 z-40 flex justify-center pt-5 px-4">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/contacto"
              className="hidden sm:flex items-center gap-2 px-4 py-2 rounded-full bg-coral-500 hover:bg-coral-400 text-white text-xs font-sans font-700 tracking-wide transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] active:scale-[0.97] group shadow-[0_4px_16px_-4px_rgba(244,114,79,0.5)]"
            >
            ...
            <button
              ...
              className={`w-9 h-9 rounded-full flex items-center justify-center transition-all duration-300 lg:hidden relative ${isLight ? "bg-deep-900/6 border border-deep-900/12 text-deep-900 hover:bg-deep-900/10" : "bg-white/10 border border-white/15 text-white hover:bg-white/20"}`}
              aria-label="Menú"
            >
              ...
              {open && <X weight="light" size={18} className="absolute" />}
            </button>
          </div>
        </nav>
      </header>
